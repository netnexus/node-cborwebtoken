...
describe(".mac()", () => {
    it("should return the CborWebToken as a string", async () => {
        ...
        // assert
        chai_1.expect(test).to.eql("d83dd18443a10104a05850a70175636f61703a2f2f61732e6578616d706c652e636f6d0"
...
describe(".decode()", () => {
    it("should return the payload without verifying if the signature is valid", async () => {
        ...
        // assert
        chai_1.expect(payload).to.eql(cbor.decode("A76369737375636F61703A2F2F61732E6578616D706C65"
