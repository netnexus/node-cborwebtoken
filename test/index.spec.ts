...
describe(".verify", () => {
    it("should return the payload if the signature is valid. If not it will throw an Error", async () => {
        ...
        // assert
        // tslint:disable-next-line:max-line-length
        expect(payload).to.equal("a70175636f61703a2f2f61732e6578616d706c652e636f6d02656572696b77037818636f61703a2f2f6c696768742e6578616d706c652e636f6d041a91ad78b0051a5610d9f0061a5610d9f007420b71");
    });
});
  /**
